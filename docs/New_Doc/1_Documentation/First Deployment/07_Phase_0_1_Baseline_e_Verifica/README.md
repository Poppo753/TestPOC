# Fasi 0–1 — Baseline e verifica explorer

Questa cartella applica la struttura di `docs/New_Doc/1_Documentation/Prompt.md` alle prime due fasi della roadmap.

Ordine di lettura:

1. `00_Stato_Attuale_e_Audit.md`;
2. `01_Strategia_Espansa_e_Revisionata.md`;
3. `02_Checklist_Verificata.md`;
